export const StoriesHeroPlaceholder = () => {
  return (
    <div className=" w-full lg:w-4/5 mb-20 bg-primary-background-blend mt-10">
      <div className="flex flex-col justify-end relative">
        <div className="w-full h-[600px] block" />
        <div
          ...
          <div className="flex flex-row gap-2 items-center justify-between">
            <p className={`m-0 font-thin w-40 h-5 bg-cyan bg-opacity-10`}></p>
            <div className="h-9 w-full mb-5 flex">
              <div className="ml-auto bg-transparent flex">
