...
// import { UserAvatarPlaceholder } from '@/components/profiles/UserAvatarPlaceholder';

const UserTitle = () => {
  return (<div className="flex flex-col w-4/5 lg:w-3/5 xl:w-2/5">
      <div className="flex">
...
export const DefaultLoading = ({ data }: any) => {
    return (<div className="mb-2 border border-primary-color/40 w-full flex flex-col">
