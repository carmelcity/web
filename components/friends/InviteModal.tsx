...
export const InviteModal = ({ isModalOpen, setModalOpen }: any) => {
  ...
  const handleAuth = async (data: any) => {
    setIsWaiting(true)
    showSuccessToast(`Invitation sent via email`);
  }
  ...
  const modalTitle = () => error ? "Oh no, please try again" : "Invite a friend"
  const modalIcon = () => error ? "ExclamationTriangleIcon" : "UserPlusIcon" 
  const waitingMessage = () => "Invitation sent"
