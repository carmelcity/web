...
import { readexPro, Tags, SimpleAvatar } from '~/elements'

export const ThumbCard = (props: any) => {
...
//   } 
  ...
  const People = () => {
    return <div className="flex flex-row w-full pl-4 mt-4 lg:mt-0 items-center justify-start">
      { people.map((p: any, i: number) => <div key={`${i}-num`} className='-ml-2 z-10'><SimpleAvatar src={props.authorImageLink} className=""/></div>)}
