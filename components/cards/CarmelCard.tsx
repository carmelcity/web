...
return <div onClick={onSelect} className={`${wide ? '' : 'hover:scale-100 scale-95 transform transition duration-500'} cursor-pointer flex lg:flex-row flex-col justify-start relative mb-8 w-full border border-primary/50 p-4 bg-black/50`}>
