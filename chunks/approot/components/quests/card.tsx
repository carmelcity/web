...
const Tag = ({ msg, i }: { msg: string; i: number }) => <div className="badge badge-outline p-4"> {msg} </div>;

const Tags = ({ tags }: { tags: string[] }) => tags.map((msg: string, i: number) => <Tag key={i} i={i} msg={msg} />);

export default () => {
  const imgSrc = 'https://blog.nzibs.co.nz/wp-content/uploads/2020/02/Landscape-1280x640.jpg';

  return (
    <div className="card w-96 bg-base-100 shadow-xl">
      <figure className="border border-primary-color">
        <img src={imgSrc} />
      </figure>
