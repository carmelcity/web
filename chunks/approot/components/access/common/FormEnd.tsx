...
export default ({ text, onComplete, fields }: any) => {
  return (
    <div className="xl:w-full mx-5 lg:mx-32 xl:mx-0 h-auto bg-transparent p-10 rounded-md shadow-lg backdrop-blur-lg border border-[2px] border-dark-turquoise z-30 relative mt-10 xl:mt-0">
      ...
      <h1 className="text-lg mt-2">{text.form.endSubtitle}</h1>
