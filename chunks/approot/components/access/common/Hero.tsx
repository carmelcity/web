      ...
      <motion.div
        ...
        <div className="relative z-20 flex flex-col items-start gap-4 lg:px-20 lg:w-3/5 ">
          <div className="flex flex-col items-start gap-2">
            ...
            <span className={`${readexPro.className} text-left text-2xl xxs:text-4xl md:text-5xl font-bold w-full`}>
              {text.title}
            </span>
            <div
          ...
          <div className="flex flex-col lg:items-start lg:w-fit w-full items-center xxs:mt-8">
            ...
            <div
              className={`${readexPro.className} text-xs xxs:text-lg font-thin md:font-light text-cyan mt-2 items-center flex flex-col w-full`}>
              <div>{text.actionSubtitle}</div>
            </div>
          </div>
        </div>
      </motion.div>
