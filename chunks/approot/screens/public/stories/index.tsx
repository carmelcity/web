  ...
  return (
    <Container>
      <div className="bg-dark-indigo w-full flex justify-center m-auto">
        ...
        <div className="w-full mb-10 flex justify-center min-h-screen max-w-[1920px] relative z-10">
          <div className="flex flex-col justify-center items-center w-11/12 pb-32 pt-40 min-h-full">
            ...
            <Title
              decription="Stories"
              moreClasses={`text-center text-2xl text-white uppercase`}
              isLoading={isLoadingStories}
            />
            <button
              className={`${readex_pro.className} bg-cyan text-black p-3 rounded-sm mt-10 mb-10`}
      ...
      <CreateStory isModalOpen={isCreateStoryModalOpen} setModalOpen={setIsCreateStoryModalOpen} />
    </Container>
  );
};
